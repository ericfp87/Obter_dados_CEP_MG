...
df_path = r'C:\Users\Eric\Downloads\CEP_falha.csv'
...
result_file_path = r'C:\Users\Eric\Downloads\LOGRADOUROS_MG2.csv'
...
for index, row in df.iterrows():
    ...
    if response.status_code == 200:
        ...
        #time.sleep(0.2)  # Pausar para evitar excesso de requisições
